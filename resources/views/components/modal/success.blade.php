...
// no blade 
{{--  @if (session('success'))
<x-modal.alert class="bg-amarelo-200" :message="session('success')"></x-modal.alert>
@endif  --}}

//gerar
//session()->flash('success', 'Cores escolhidas por mim, não diga que não gosta');