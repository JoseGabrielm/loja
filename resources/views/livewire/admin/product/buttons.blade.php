<div class="flex flex-wrap mx-5 md:justify-between">
    <div class="flex">
    ...
    <div class="flex space-x-6">
        ...
        <div class="pr-8 pt-6 z-10 ">
            <input wire:model="active" type="checkbox" value="ativado" class="mr-3 leading-tight">Somente ativos</input>
        </div>
    </div>
</div>
